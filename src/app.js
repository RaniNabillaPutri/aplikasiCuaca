...
app.get('/bantuan', (req, res) => {
    res.render('bantuan', {
        title: 'Bantuan',
        teksBantuan: 'Ada yang bisa Kami bantu?',
        name: 'Rani Nabilla Putri'
    })
})
// app.get('/', (req, res) => {
...
app.get('/infocuaca', (req, res) => {
    if(!req.query.address){
        return res.send({
            error:'Masukkan lokasi dengan benar!'
        })
    }
...
app.get('/berita', async (req, res) => {
    try {
        ...
        const apiKey = '16e381e83fa7e1bce51b28080b060fcf';
        ...
        res.render('error', {
            ...
            pesanKesalahan: 'Terjadi kesalahan pada laman berita.',
        });
    }
});
...
app.get('/bantuan/*', (req, res) => {
    res.render('404',{
        title: '404',
        name: 'Rani Nabilla Putri',
        pesanError: 'Bantuan belum tersedia.'
    })
})
